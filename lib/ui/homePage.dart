                                              ...
                                              Stack(
                                                children: [
                                                  CircularProgressIndicator(
                                                    value: (myBooksMyReads[index].currentPage/myBooksMyReads[index].totalPage),
                                                    strokeWidth: 5.0,
                                                  ...
                                                  Positioned(
                                                    ...
                                                    left: 5,
                                                    child: Text(
                                                      "${((myBooksMyReads[index].currentPage/myBooksMyReads[index].totalPage)*100).toStringAsFixed(1)}%",
                                                      style: TextStyle(
